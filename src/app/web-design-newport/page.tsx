...
export const metadata: Metadata = {
    title: 'Web Design Newport | Professional Website Design Services',
    description: 'Expert web design services in Newport, South Wales. Amity Web Solutions creates stunning, responsive websites for Newport businesses. Based nearby with over 400 websites built.',
};

/*----------------------------------------
Web Design Newport Page
----------------------------------------*/
export default function WebDesignNewportPage()
{
    return (
        <>
            {/* Hero Section */}
                ...
                <div className="container">
                    <div className="max-w-4xl">
                        <h1 className="hero-title mb-6">
                            Web Design <span className="text-[var(--primary)]">Newport</span>
                        </h1>
                        <p className="text-xl text-[var(--muted)] mb-8">
                            Professional web design services for Newport businesses. We create stunning, 
            ...
            <section className="section">
                <div className="container">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl font-bold mb-6">Newport&apos;s Trusted Web Design Partner</h2>
                            <p className="text-lg text-[var(--muted)] mb-6">
                                Based in nearby Caerphilly, Amity Web Solutions has been delivering exceptional 
                                web design services to Newport businesses since 2005. We understand the local 
                                market and what businesses in Newport need to succeed online.
                            </p>
                            <p className="text-lg text-[var(--muted)] mb-6">
                                Whether you&apos;re a business in Newport city centre, the Friars Walk area, 
                                or the surrounding areas like Cwmbran, Pontypool, or the valleys, we have 
                                the expertise to create a website that works for your business.
                            </p>
                        ...
                        <div className="bg-[var(--surface)] rounded-2xl p-8">
                            ...
                            <ul className="space-y-4 text-[var(--muted)]">
                                ...
                                <li className="flex gap-3">
                                    ...
                                    <span>Long-term relationships with Newport businesses</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="text-center mb-14">
                        ...
                        <p className="section-subtitle mx-auto">
                            Complete web design and development services for Newport businesses
                        </p>
                    </div>
            ...
            <section className="section">
                <div className="container">
                    <div className="max-w-3xl mx-auto text-center">
                        <h2 className="section-title">Serving Newport and Gwent</h2>
                        <p className="text-lg text-[var(--muted)] mb-8">
                            From our base in Caerphilly, we&apos;re perfectly positioned to serve businesses across 
                            Newport and the wider Gwent region. We&apos;ve worked with businesses in Newport city centre, 
                            Cwmbran, Pontypool, Caerleon, and many surrounding areas.
                        </p>
                        <p className="text-lg text-[var(--muted)] mb-8">
                ...
                <div className="container">
                    <div className="text-center text-white">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            Ready to Discuss Your Newport Web Design Project?
                        </h2>
